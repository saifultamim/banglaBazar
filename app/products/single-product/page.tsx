...
export default function SingleProductPage({productName,productWeight,productPrice,productImg}:Props) {
  ...
  return (
    <div className="card-width mx-auto border border-[#BBBBBB] rounded-[20px] p-3 cursor-pointer"
    ...
    >
      ...
      <div className="flex justify-between items-center ">
       ...
       <div className="flex items-center justify-between bg-green-dark text-white px-2 py-1 rounded-[3px] w-2/2 border gap-1"><HiShoppingCart className="text-xl"  />
          <button className="text-[14px]" onClick={()=>addToCart({productName,productWeight,productPrice})}>Add to cart</button>
        </div>
      </div>
      <Link href='/products/product-specific'
