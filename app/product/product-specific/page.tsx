...
export default function ProductSpecificPage() {
  return (
    <div className="w-[80%] mx-auto p-4 bg-card text-card-foreground rounded-lg shadow-md">
      ...
      <div className="flex flex-col md:flex-row">
        ...
        <div className="md:ml-6 mt-4 md:mt-0 flex flex-col justify-between">
          <div>
            ...
            <p className="text-lg md:text-xl font-normal">Unit: EACH</p>
            <p className="text-lg md:text-xl font-normal">Brand: Unilever</p>
          ...
          <div className="flex items-center justify-start bg-[#3D6B51] text-white px-2 py-1 rounded-lg mt-4 w-full">
            <HiShoppingCart className="text-lg" />
            <button className="text-lg text-center ml-4">Add to cart</button>
          </div>
        </div>
      </div>

      <div className="py-10">
        <h3 className="text-lg md:text-xl font-semibold">Product Details</h3>
        <ul className="mt-2 space-y-1 text-sm md:text-base">
          ...
          <li>Removes harmful pesticides to make water safe for consumption</li>
          <li>HIPS / ABS body</li>
          <li>Made of strong plastic to ensure the purifier has a long life</li>
      ...
      <div>
        <h3 className="text-xl md:text-2xl font-bold text-[#3D6B51] text-center">
          SIMILAR PRODUCTS
        </h3>
